...
namespace WorkSchedule.Application.Migrations
{
    ...
    [Migration("20220324192855_ReceiveEmailsPropAdded")]
    partial class ReceiveEmailsPropAdded
    {
            ...
            modelBuilder.Entity("WorkSchedule.Application.Persistency.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0696fc63-0f91-4091-b15d-65ae8aee423d",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "ced1f067-05a8-4007-b959-c994b1b9cf98",
                            Name = "Administrator",
